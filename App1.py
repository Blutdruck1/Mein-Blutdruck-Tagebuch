...
tab1, tab2, tab3 = st.tabs(["Eingabe", "Informationen", "Auswertung"])
...
with tab2:
    ...
    #Informationsfeld zur Messung
    st.info('Tipps wie Sie ihr Blutdruck positiv beeinflussen können: Die Ernährung ist ein wichtiger Faktor, der den Blutdruck beeinflusst. Eine gesunde und ausgewogene Ernährung kann einen positiven Einfluss auf den Blutdruck haben. Versuchen Sie die Menge an Kochsalz in den Mahlzeiten zu reduzieren. Des Weiteren haben Früchte, Gemüse und Fisch eine reduzierende und positive Wirkung auf den Blutdruck, sowie regelmässige körperliche Aktivität.', icon="ℹ️")
